...
inline int writeInBufferStandard(info * infos, int FlowId, int ptrSeqNum, char *SrcHost,
    char *DestHost, const char* proto, in_port_t tmp_portSrc, in_port_t tmp_portDest ,long time1, long time2,
